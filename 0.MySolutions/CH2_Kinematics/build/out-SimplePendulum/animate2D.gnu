...
y1 = `@command1`
set arrow 1 from 0,0 to x1,y1 lw 1 lc rgb '#FFFFFF'
set arrow 11 from x1,(y1-0.05) to x1,y1 lw 3 lc rgb '#90EE90'
plot file1 \
...
y2 = `@command2`
set arrow 2 from 0,0 to x2,y2 lw 1 lc rgb '#FFFFFF'
set arrow 12 from x2,(y2-0.05) to x2,y2 lw 3 lc rgb '#90EE90'
plot file2 \
 using 2:($1<= t0 ? $3: 1/0) with lines lw 0 lc rgb '#000000' notitle
...
y3 = `@command3`
set arrow 3 from 0,0 to x3,y3 lw 1 lc rgb '#FFFFFF'
set arrow 13 from x3,(y3-0.05) to x3,y3 lw 3 lc rgb '#90EE90'
plot file3 \
 using 2:($1<= t0 ? $3: 1/0) with lines lw 0 lc rgb '#000000' notitle
...
y4 = `@command4`
set arrow 4 from 0,0 to x4,y4 lw 1 lc rgb '#FFFFFF'
set arrow 14 from x4,(y4-0.05) to x4,y4 lw 3 lc rgb '#90EE90'
plot file4 \
 using 2:($1<= t0 ? $3: 1/0) with lines lw 0 lc rgb '#000000' notitle
...
y5 = `@command5`
set arrow 5 from 0,0 to x5,y5 lw 1 lc rgb '#FFFFFF'
set arrow 15 from x5,(y5-0.05) to x5,y5 lw 3 lc rgb '#90EE90'
plot file5 \
 using 2:($1<= t0 ? $3: 1/0) with lines lw 0 lc rgb '#000000' notitle
...
y6 = `@command6`
set arrow 6 from 0,0 to x6,y6 lw 1 lc rgb '#FFFFFF'
set arrow 16 from x6,(y6-0.05) to x6,y6 lw 3 lc rgb '#90EE90'
plot file6 \
 using 2:($1<= t0 ? $3: 1/0) with lines lw 0 lc rgb '#000000' notitle
...
y7 = `@command7`
set arrow 7 from 0,0 to x7,y7 lw 1 lc rgb '#FFFFFF'
set arrow 17 from x7,(y7-0.05) to x7,y7 lw 3 lc rgb '#90EE90'
plot file7 \
 using 2:($1<= t0 ? $3: 1/0) with lines lw 0 lc rgb '#000000' notitle
...
y8 = `@command8`
set arrow 8 from 0,0 to x8,y8 lw 1 lc rgb '#FFFFFF'
set arrow 18 from x8,(y8-0.05) to x8,y8 lw 3 lc rgb '#90EE90'
plot file8 \
 using 2:($1<= t0 ? $3: 1/0) with lines lw 0 lc rgb '#000000' notitle
...
y9 = `@command9`
set arrow 9 from 0,0 to x9,y9 lw 1 lc rgb '#FFFFFF'
set arrow 19 from x9,(y9-0.05) to x9,y9 lw 3 lc rgb '#90EE90'
plot file9 \
 using 2:($1<= t0 ? $3: 1/0) with lines lw 0 lc rgb '#000000' notitle
...
y10 = `@command10`
set arrow 20 from 0,0 to x10,y10 lw 1 lc rgb '#FFFFFF'
set arrow 21 from x10,(y10-0.05) to x10,y10 lw 3 lc rgb '#90EE90'
plot file10 \
 using 2:($1<= t0 ? $3: 1/0) with lines lw 0 lc rgb '#000000' notitle
